...
class UserProfile extends Component {
  ...
  getPrivateTabState(props) {
    ...
    const tabs = [
      ...
      { id: "torah-tracker", text: Sefaria._("profile.buddhish_text_tracker"), invisible: Sefaria._uid !== props.profile.id, icon: "/static/icons/chart-icon.svg", href: "/fodiantracker", applink: true, justifyright: true}
    ];
    if (showNotes) {
            ...
            { !this.props.profile.id ? <LoadingMessage /> :
              <div>
                ...
                >
                  ...
                  />
                  <div className="fodiantrackerPlaceholder filterable-list" />
                  { this.state.showBio ?
